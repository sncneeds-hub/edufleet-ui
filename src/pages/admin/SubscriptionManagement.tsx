      ...
      switch (actionDialog.type) {
        ...
        case 'changePlan':
          ...
          await apiClient.put(`/admin/users/${userId}/status`, { 
            ...
            notes: `Plan changed by admin to ${plans.find(p => p.id === selectedPlanId)?.displayName}`
          }, { requiresAuth: true });
        ...
        case 'reactivate':
          await reactivateUserSubscription(subId);
      ...
      {requests.length > 0 && (
        <Card className="p-6 border-amber-200 bg-amber-50/30">
          <div className="flex items-center gap-2 mb-4">
            ...
            <Badge className="bg-amber-100 text-amber-700 ml-2">{requests.length}</Badge>
          </div>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {actionDialog.type === 'markPaid' && 'Confirm that the bank transfer for this subscription has been received and verified.'}
